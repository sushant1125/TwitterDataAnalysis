...
public class Stripes_relativefreq {

	private static final transient Logger LOG = LoggerFactory.getLogger(Stripes_relativefreq.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(Stripes_relativefreq.class);
