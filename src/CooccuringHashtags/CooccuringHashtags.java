...
public class CooccuringHashtags {

	private static final transient Logger LOG = LoggerFactory.getLogger(CooccuringHashtags.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CooccuringHashtags.class);
