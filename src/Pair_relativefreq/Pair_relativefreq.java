...
import CooccuringHashtags.HashTagPartitioner;

public class Pair_relativefreq {

	private static final transient Logger LOG = LoggerFactory.getLogger(Pair_relativefreq.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(Pair_relativefreq.class);
		job.setMapperClass(TokenizerMapper.class);
		
		//job.setCombinerClass(IntSumReducer.class);
		job.setMapOutputKeyClass(Text.class);
		job.setMapOutputValueClass(IntWritable.class);
	//	job.setPartitionerClass(HashTagPartitioner.class);
