...
public class CooccuringHashtags_Stripes {

	private static final transient Logger LOG = LoggerFactory.getLogger(CooccuringHashtags_Stripes.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CooccuringHashtags_Stripes.class);
