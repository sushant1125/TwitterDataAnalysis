...
public class MostTrendingHashtags {

	private static final transient Logger LOG = LoggerFactory.getLogger(MostTrendingHashtags.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(MostTrendingHashtags.class);
